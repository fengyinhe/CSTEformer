...
class STEViT(nn.Module):
    def __init__(
            ...
            *,
            ...
            dropout=0.,
            emb_dropout=0.,
            variant='Spatiotemporal_attention',
    ):
        super().__init__()
        ...
        if variant == 'Spatiotemporal_attention':
            ...
            self.temporal_transformer = Temporal_Transformer(dim, temporal_depth, heads, dim_head, mlp_dim, dropout)
